...
_Ältere `## Last session`-Einträge (D75 One-Shot-Setup, D74 Delivery-Pipeline-Auslagerung, D73 `_TurnTiming`-Auslagerung,
D70–D72 `orchestrator`-E1–E4-Verschlankung, D69 `puffer`-Modus, D68 globaler Sprech-Modus, D67 Shutdown-Leave-Limit u. a.):
siehe **[docs/progress-archive.md](docs/progress-archive.md)**._
