...
- **Newest round:** Journal-Runde (2026-07-17, D100 → ADR 053): Szenengrenzen-Events +
  `time_minutes` im Session-Journal — Prep für Session-RAG. Suite 716 grün, `dm-eval`
  Exit 0. Kein neues Live-Gate (Metadaten-only, Suite + dm-eval decken alles).
...
_Ältere Current-focus-Blöcke (D99 Debug-Overlay, D98 Marker-Registry u. a.): siehe [docs/progress-archive.md](docs/progress-archive.md), `## Current focus (Verlauf)`._
