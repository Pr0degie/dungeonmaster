...
- _Live offen (nach dem Gate): `!sprechmodus puffer` (+ Tiefe variieren) gegen `stream`/`nahtlos` hören; fürs Gate
  selbst `stream` nehmen (zügig)._

_Ältere `## Last session`-Einträge (D68 globaler Sprech-Modus, D67 Shutdown-Leave-Limit, D66 CPU-Ursache/`!intro`,
D65 Seamless-Spur u. a.): siehe **[docs/progress-archive.md](docs/progress-archive.md)**._
