...
- **Newest round:** Der Debug-Abend ist wieder spielbar (2026-08-15, D103/D104 → ADR 056). Er
  lief in der falschen Kampagne, weil die ADR-055-Sandbox nur Archive und RAG-Source trennte;
  jetzt bekommen Debug-Runs `.debug`-Zwillinge für state/history/chekhov/recap. Dazu der
  [Testabend-Ablauf](docs/testabend-ablauf.md) mit vier darin gefundenen falschen
  Kommando-Anweisungen, und Tippfehler antworten statt stumm zu scheitern. Suite 778 grün.
- **Next concrete step:** Die Debug-Kampagne erneut live spielen —
  ...
  Offen vorab: läuft Bot A auf Timos Rechner oder auf Tobis?
...
_Ältere Current-focus-Blöcke (Debug-Sandbox + G10 D102 → ADR 055, Session-RAG-Runde D101 → ADR 054, Journal-Runde D100 → ADR 053, Content-Runde Debug-Kampagne „Die Mitternachtsfracht“ 2026-07-11, D99 Debug-Overlay, D98 Marker-Registry u. a.): siehe [docs/progress-archive.md](docs/progress-archive.md), `## Current focus (Verlauf)`._
