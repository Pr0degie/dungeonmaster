...
- **Newest round:** Der Debug-Abend ist wieder spielbar (2026-08-15, D103/D104 → ADR 056). Er
  ...
  jetzt bekommen Debug-Runs `.debug`-Zwillinge. Dazu der
  [Testabend-Ablauf](docs/testabend-ablauf.md) mit vier darin gefundenen falschen
  Kommando-Anweisungen, eine Fehlermeldung bei Tippfehlern statt Stille, und
  `tools/cleanup_15aug.py`. Suite 778 grün.
