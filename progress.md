...
- **Newest round:** Die Party hat einen vierten Spieler (2026-08-22, D105) — Vincent spielt
  den Enginseer Vinzentius Kabelbrand, der die zwei Lücken der Party füllt (Fernkampf,
  Technologie). Drei Run-Dokumente und die `_default`-Party kannten nur drei Namen; der
