...
_Ältere `## Last session`-Einträge (D73 `_TurnTiming`-Auslagerung, D70–D72 `orchestrator`-E1–E4-Verschlankung, D69
`puffer`-Modus, D68 globaler Sprech-Modus, D67 Shutdown-Leave-Limit u. a.): siehe **[docs/progress-archive.md](docs/progress-archive.md)**._
