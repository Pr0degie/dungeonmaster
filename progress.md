...
- **Newest round:** D98 → ADR 051 (marker pipeline consolidated onto the declarative
  ...
  slimmed) + lessons layer bootstrap (`docs/lessons/`, 16 lessons + README, wired into the
  CLAUDE.md ritual — workflow migration round 3/5).
- **Next concrete step:** Roadmap-table replacement + skill redundancy sweep round
  (workflow migration round 4/5).
...
**Roadmap-table replacement + skill redundancy sweep round** (Workflow-Migration Runde 4/5; der Live-Run-Fahrplan unten bleibt die Projekt-Prio).
