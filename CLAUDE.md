...
dmbot/          the DM bot
  ...
  voice/        recv, resample, VAD + the Discord cogs (voicecog / dicecog / dmcog + scenecog / lorecog / clockcog, ADR 039/047) + delivery.py (the answer→audio turn-delivery pipeline, ADR 035)
